    ...
    >
      ...
      <div className="flex flex-col space-y-4 md:space-y-6 w-full md:w-2/3">
        {faqData.map((item, index) => (
          <div
            key={index}
            className="border-[2px] border-gray-250  rounded-3xl transition-all duration-300 ease-in-out"
          >
            <div
              className="flex justify-between items-center cursor-pointer px-[16px] md:px-6 py-[25px] md:py-5 w-full"
